package com.app.efa.views.jobapplications;

import com.app.efa.views.MainLayout;
...
@Route(value = "jobApplications", layout = MainLayout.class)
public class JobApplicationsView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public JobApplicationsView() {
        addClassName("job-applications-view");
        setSizeFull();
        grid.setHeight("100%");
